...
public class ExercisesInteractorImpl implements ExercisesInteractor {
    ...
    @Override
    public void prikaziVjezbe(final OnFinishedListener listener) {
